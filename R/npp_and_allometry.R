...
x16 <- read.csv("./data-raw/vst_apparentIndividuals2016_goughSites.csv")
...
n.17pt1 <- read.csv("./data-raw/apparentindividual_fulcrum_2017_1st7sites.csv")
n.17pt2 <- read.csv("./data-raw/apparentindividual_fulcrum_2017_2nd7sites.csv")
...
tree.id <- read.csv("./data-raw/vst_mappingTagging2016_goughSites.csv")
...
tax.jenk <- read.csv("./data-raw/neon_taxon_jenkins.csv")
